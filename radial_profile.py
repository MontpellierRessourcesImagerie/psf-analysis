...
def draft(ImIn):
    ...
    for i in range(0, len(table)):
        ...
        # Create a list to store the sum of all voxels intersecting the plane while rotating continuously 5° of the plane
        sums = []
        xs = []
        ys = []
        ...
        for degree in range(num_degrees):
            ...
            p1 = (
                p1[0] * math.cos(angle) - math.sin(angle) * p1[1],
                p1[0] * math.sin(angle) + math.cos(angle) * p1[1]
            )

            p2 = (
                p2[0] * math.cos(angle) - math.sin(angle) * p2[1],
                p2[0] * math.sin(angle) + math.cos(angle) * p2[1]
            )
